 ...
 * @param size the size or length of the array
 * @return holds the maximum value of the array as max.
 */
 ...
 * @param a[] the array in question
 * @param size the size or length of the array
 * @return holds the minimum value of the array as min.
 */
...
/** Returns the integer midpoint value of an array's max and min
 * @param min The minimum of the array and the first addend of the numerator
 * @param max The maximum of the array and the second addend of the numerator
 * @return the quotient of min + max divided by a contant of 2
 */
...
/** Counts the number of elements in an array that are less than, less than or
 * equal to, greater than, greater or equal to, or equal to a specified number x
 * @param a[] The array whose elements are counted
 * @param size The length of the array
 * @param type The specified count case/requirements
 * @param x The specified number that the elements are compared to
 * @return The number of elements that are less than, less than or
 * equal to, greater than, greater or equal to, or equal to a specified number x
 */
